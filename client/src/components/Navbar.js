                    ...
                    <div className="container mx-auto">
                        <nav className='flex bg-transparent box-border justify-between'>
                            ...
                            <ul className='flex text-sm items-center text-[#0095ff]'>
                                ...
                                <a className='border-[1px] border-solid border-[#000] rounded-full bg-[#0095ff] text-[#fff] hover:bg-[#fff] hover:text-[#0095ff] px-3 py-1' href="/signin" target="_blank"><li><button>Sign-In</button></li></a>
                            </ul>
                        </nav>
                    </div>
                </div>
